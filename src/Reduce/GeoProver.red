...
algebraic procedure is_cc_tangent(c1_,c2_);
...
algebraic procedure on_bisector(P__,A__,B__,C__);
	eq_angle(A__,B__,P__,P__,B__,C__);

algebraic procedure orthocenter(A__,B__,C__);
	intersection_point(altitude(A__,B__,C__),altitude(B__,C__,A__));

algebraic procedure other_cc_point(P__,c1_,c2_);
	other_cl_point(P__,c1_,radical_axis(c1_,c2_));

algebraic procedure other_incenter(M__,A__,B__);
	intersection_point(ortho_line(A__,pp_line(M__,A__)),ortho_line(B__,pp_line(M__,B__)));

algebraic procedure p3_angle(A__,B__,C__);
	l2_angle(pp_line(B__,A__),pp_line(B__,C__));

algebraic procedure p3_circle(A__,B__,C__);
	pc_circle(intersection_point(p_bisector(A__,B__),p_bisector(A__,C__)),A__);
...
algebraic procedure pappus_line(A__,B__,C__,D__,E__,F__);
	pp_line(intersection_point(pp_line(A__,E__),pp_line(B__,D__)),intersection_point(pp_line(A__,F__),pp_line(C__,D__)));
