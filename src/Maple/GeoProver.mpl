...
`geoprover/altitude`:=proc(A_::Point,B_::Point,C_::Point)
	`geoprover/ortho_line`(A_,`geoprover/pp_line`(B_,C_)) end:
`geoprover/centroid`:=proc(A_::Point,B_::Point,C_::Point)
	`geoprover/intersection_point`(`geoprover/median`(A_,B_,C_),`geoprover/median`(B_,C_,A_)) end:
`geoprover/circumcenter`:=proc(A_::Point,B_::Point,C_::Point)
	`geoprover/intersection_point`(`geoprover/p_bisector`(A_,B_),`geoprover/p_bisector`(B_,C_)) end:
`geoprover/csym_point`:=proc(P_::Point,Q_::Point)
	`geoprover/varpoint`(Q_,P_,-1) end:
`geoprover/fixedpoint`:=proc(A_::Point,B_::Point,u_::Scalar)
	`geoprover/varpoint`(A_,B_,u_) end:
`geoprover/is_cc_tangent`:=proc(c1_::Circle,c2_::Circle)
	`geoprover/is_cl_tangent`(c1_,`geoprover/radical_axis`(c1_,c2_)) end:
`geoprover/is_concyclic`:=proc(A_::Point,B_::Point,C_::Point,D_::Point)
	`geoprover/on_circle`(D_,`geoprover/p3_circle`(A_,B_,C_)) end:
`geoprover/median`:=proc(A_::Point,B_::Point,C_::Point)
	`geoprover/pp_line`(A_,`geoprover/midpoint`(B_,C_)) end:
`geoprover/midpoint`:=proc(A_::Point,B_::Point)
	`geoprover/fixedpoint`(A_,B_,1/2) end:
`geoprover/on_bisector`:=proc(P_::Point,A_::Point,B_::Point,C_::Point)
	`geoprover/eq_angle`(A_,B_,P_,P_,B_,C_) end:
`geoprover/orthocenter`:=proc(A_::Point,B_::Point,C_::Point)
	`geoprover/intersection_point`(`geoprover/altitude`(A_,B_,C_),`geoprover/altitude`(B_,C_,A_)) end:
`geoprover/other_cc_point`:=proc(P_::Point,c1_::Circle,c2_::Circle)
	`geoprover/other_cl_point`(P_,c1_,`geoprover/radical_axis`(c1_,c2_)) end:
`geoprover/other_incenter`:=proc(M_::Point,A_::Point,B_::Point)
	`geoprover/intersection_point`(`geoprover/ortho_line`(A_,`geoprover/pp_line`(M_,A_)),`geoprover/ortho_line`(B_,`geoprover/pp_line`(M_,B_))) end:
`geoprover/p3_angle`:=proc(A_::Point,B_::Point,C_::Point)
	`geoprover/l2_angle`(`geoprover/pp_line`(B_,A_),`geoprover/pp_line`(B_,C_)) end:
`geoprover/p3_circle`:=proc(A_::Point,B_::Point,C_::Point)
	`geoprover/pc_circle`(`geoprover/intersection_point`(`geoprover/p_bisector`(A_,B_),`geoprover/p_bisector`(A_,C_)),A_) end:
`geoprover/p9_center`:=proc(A_::Point,B_::Point,C_::Point)
	`geoprover/circle_center`(`geoprover/p9_circle`(A_,B_,C_)) end:
`geoprover/p9_circle`:=proc(A_::Point,B_::Point,C_::Point)
	`geoprover/p3_circle`(`geoprover/midpoint`(A_,B_),`geoprover/midpoint`(A_,C_),`geoprover/midpoint`(B_,C_)) end:
`geoprover/p_bisector`:=proc(B_::Point,C_::Point)
	`geoprover/ortho_line`(`geoprover/midpoint`(B_,C_),`geoprover/pp_line`(B_,C_)) end:
`geoprover/pappus_line`:=proc(A_::Point,B_::Point,C_::Point,D_::Point,E_::Point,F_::Point)
	`geoprover/pp_line`(`geoprover/intersection_point`(`geoprover/pp_line`(A_,E_),`geoprover/pp_line`(B_,D_)),`geoprover/intersection_point`(`geoprover/pp_line`(A_,F_),`geoprover/pp_line`(C_,D_))) end:
`geoprover/pedalpoint`:=proc(P_::Point,a_::Line)
	`geoprover/intersection_point`(`geoprover/ortho_line`(P_,a_),a_) end:
`geoprover/sqrdist_pl`:=proc(A_::Point,l_::Line)
	`geoprover/sqrdist`(A_,`geoprover/pedalpoint`(A_,l_)) end:
`geoprover/sym_point`:=proc(P_::Point,l_::Line)
	`geoprover/fixedpoint`(P_,`geoprover/pedalpoint`(P_,l_),2) end:
`geoprover/triangle_area`:=proc(A_::Point,B_::Point,C_::Point)
	1/2*`geoprover/is_collinear`(A_,B_,C_) end:
# GeoProver code end.
